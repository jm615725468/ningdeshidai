...
namespace HNSys
{
    public partial class FrmHistoryCurvecs : Form
    {
        ...
        private void InitSet()
        {
            ...
            string 时间范围 = IniHelper.ReadIniData("FrmHistoryCurvecs_Set", "时间范围", "", SetSavePath);
            if (时间范围 != "")
            {
                numericUpDown1.Value = decimal.Parse(时间范围);
            }

            string Y轴最大值 = IniHelper.ReadIniData("FrmHistoryCurvecs_Set", "Y轴最大值", "", SetSavePath);
            if (Y轴最大值 != "")
            {
                numericUpDown3.Value = decimal.Parse(Y轴最大值);
                Ymax = int.Parse(Y轴最大值);
            }
            string Y轴最小值 = IniHelper.ReadIniData("FrmHistoryCurvecs_Set", "Y轴最小值", "", SetSavePath);
            if (Y轴最小值 != "")
            {
                numericUpDown2.Value = decimal.Parse(Y轴最小值);
                Ymin = int.Parse(Y轴最小值);
            }
            string 调整范围 = IniHelper.ReadIniData("FrmHistoryCurvecs_Set", "调整范围", "", SetSavePath);
            if (调整范围 != "")
            {
        ...
        private void InitChart()
        {
           ...
           //// chartArea1.CursorX.IsUserSelectionEnabled = true;
           //// chartArea1.AxisX.ScaleView.Zoomable = true;
           //// chartArea1.AxisX.ScaleView.Position = 1;
            ...
            // this.chart1.Series[0].ChartType = SeriesChartType.Spline; SeriesChartType.FastLine;//选快速扫描线条
            this.chart1.Series[0].ChartType = SeriesChartType.FastLine;//选快速扫描线条
                    ...
                    if (dt1.Rows.Count > 0)
                    {
                        this.BeginInvoke((EventHandler)delegate
                        {
                            ...
                            for (int ChartSum1 = 0; ChartSum1 < dt1.Rows.Count - 1; ChartSum1++)
                            {
                                ...
                                {
                                    chart1.Series[0].Points.AddXY(Parmeter.ToOADate(), float.Parse(dt1.Rows[ChartSum1][1].ToString()));
                                }

                                if (checkBox2.CheckState == CheckState.Checked)
                                {
                                    chart1.Series[1].Points.AddXY(Parmeter.ToOADate(), float.Parse(dt1.Rows[ChartSum1][2].ToString()));
                                }

                                if (checkBox3.CheckState == CheckState.Checked)
                                {
                                    chart1.Series[2].Points.AddXY(Parmeter.ToOADate(), float.Parse(dt1.Rows[ChartSum1][3].ToString()));
                                }


                                if (checkBox4.CheckState == CheckState.Checked)
                                {
                                    chart1.Series[3].Points.AddXY(Parmeter.ToOADate(), float.Parse(dt1.Rows[ChartSum1][4].ToString()));
                                }

                                if (checkBox5.CheckState == CheckState.Checked)
                                {
                                    chart1.Series[4].Points.AddXY(Parmeter.ToOADate(), float.Parse(dt1.Rows[ChartSum1][5].ToString()));
                                }

                                if (checkBox6.CheckState == CheckState.Checked)
                                {
                                    chart1.Series[5].Points.AddXY(Parmeter.ToOADate(), float.Parse(dt1.Rows[ChartSum1][6].ToString()));
                                }
        ...
        private void numericUpDown3_ValueChanged(object sender, EventArgs e)
        {
            ...
            string SetSavePath = Application.StartupPath + "\\HNSet\\SetSave.ini";
            IniHelper.WriteIniData("FrmHistoryCurvecs_Set", "Y轴最大值", numericUpDown3.Value.ToString(), SetSavePath);
        ...
        private void numericUpDown2_ValueChanged(object sender, EventArgs e)
        {
            ...
            string SetSavePath = Application.StartupPath + "\\HNSet\\SetSave.ini";
            IniHelper.WriteIniData("FrmHistoryCurvecs_Set", "Y轴最小值", numericUpDown2.Value.ToString(), SetSavePath);
        }
        private void numericUpDown1_ValueChanged(object sender, EventArgs e)
        {
            string SetSavePath = Application.StartupPath + "\\HNSet\\SetSave.ini";
            IniHelper.WriteIniData("FrmHistoryCurvecs_Set", "时间范围", numericUpDown1.Value.ToString(), SetSavePath);
        }

        private void numericUpDown4_ValueChanged(object sender, EventArgs e)
        {
            string SetSavePath = Application.StartupPath + "\\HNSet\\SetSave.ini";
            IniHelper.WriteIniData("FrmHistoryCurvecs_Set", "调整范围", numericUpDown4.Value.ToString(), SetSavePath);
        }
