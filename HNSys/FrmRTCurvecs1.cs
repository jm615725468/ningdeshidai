...
namespace HNSys
{
    ...
    public partial class FrmRTCurvecs1 : Form
    {
        ...
        private void InitSet()
        {
            ...
            string 时间范围 = IniHelper.ReadIniData("FrmRTCurvecs1_Set", "时间范围", "", SetSavePath);
            if (时间范围 != "")
            {
                numericUpDown1.Value = decimal.Parse(时间范围);
            }

            string Y轴最大值 = IniHelper.ReadIniData("FrmRTCurvecs1_Set", "Y轴最大值", "", SetSavePath);
            if (Y轴最大值 != "")
            {
                numericUpDown3.Value = decimal.Parse(Y轴最大值);
                Ymax = int.Parse(Y轴最大值);
            }
            string Y轴最小值 = IniHelper.ReadIniData("FrmRTCurvecs1_Set", "Y轴最小值", "", SetSavePath);
            if (Y轴最小值 != "")
            {
        ...
        private void numericUpDown3_ValueChanged(object sender, EventArgs e)
        {
            ...
            string SetSavePath = Application.StartupPath + "\\HNSet\\SetSave.ini";
            IniHelper.WriteIniData("FrmRTCurvecs1_Set", "Y轴最大值", numericUpDown3.Value.ToString(), SetSavePath);
        }
        ...
        private void numericUpDown2_ValueChanged(object sender, EventArgs e)
        {
            ...
            string SetSavePath = Application.StartupPath + "\\HNSet\\SetSave.ini";
            IniHelper.WriteIniData("FrmRTCurvecs1_Set", "Y轴最小值", numericUpDown2.Value.ToString(), SetSavePath);
        }

        private void numericUpDown1_ValueChanged(object sender, EventArgs e)
        {
            string SetSavePath = Application.StartupPath + "\\HNSet\\SetSave.ini";
            IniHelper.WriteIniData("FrmRTCurvecs1_Set", "时间范围", numericUpDown1.Value.ToString(), SetSavePath);
        }
